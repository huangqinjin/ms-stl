...
_STD_BEGIN
__PURE_APPDOMAIN_GLOBAL wistream* _Ptr_wcin  = nullptr;
__PURE_APPDOMAIN_GLOBAL wostream* _Ptr_wcout = nullptr;
__PURE_APPDOMAIN_GLOBAL wostream* _Ptr_wcerr = nullptr;
__PURE_APPDOMAIN_GLOBAL wostream* _Ptr_wclog = nullptr;
_STD_END
#else
_STD_BEGIN
